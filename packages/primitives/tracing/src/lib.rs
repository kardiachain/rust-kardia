// This file is part of KardiaChain.
...
//! KardiaChain tracing primitives and macros.
//!
//! To trace functions or invidual code in KardiaChain, this crate provides [`within_span`]
...
//! for wasm code in KardiaChain, as it is regularly updated with new code from on-chain
...
///
/// ```rust
/// kp_tracing::enter_span!(kp_tracing::Level::TRACE, "fn wide span");
/// {
/// 		kp_tracing::enter_span!(kp_tracing::trace_span!("outer-span"));
/// 		{
/// 			kp_tracing::enter_span!(kp_tracing::Level::TRACE, "inner-span");
/// 			// ..
/// 		}  // inner span exists here
/// 	} // outer span exists here
///
/// kp_tracing::within_span! {
/// 		kp_tracing::debug_span!("debug-span", you_can_pass="any params");
///     1 + 1;
...
/// use any valid `kp_tracing::Span`followe by `;` and the code to execute,
///
/// # Example
///
/// ```
/// kp_tracing::within_span! {
///     kp_tracing::Level::TRACE,
///     "test-span";
///     1 + 1;
///     // some other complex code
/// }
///
/// kp_tracing::within_span! {
///     kp_tracing::span!(kp_tracing::Level::WARN, "warn-span", you_can_pass="any params");
///     1 + 1;
///     // some other complex code
/// }
///
...
/// or pass in any valid `kp_tracing::Span` for extended usage. The span will
...
///
/// ```
/// kp_tracing::enter_span!(kp_tracing::Level::TRACE, "test-span");
/// // previous will be dropped here
/// kp_tracing::enter_span!(
/// 	kp_tracing::span!(kp_tracing::Level::DEBUG, "debug-span", params="value"));
/// kp_tracing::enter_span!(kp_tracing::info_span!("info-span",  params="value"));
///
/// {
/// 		kp_tracing::enter_span!(kp_tracing::Level::TRACE, "outer-span");
/// 		{
/// 			kp_tracing::enter_span!(kp_tracing::Level::TRACE, "inner-span");
/// 			// ..
/// 		}  // inner span exists here
