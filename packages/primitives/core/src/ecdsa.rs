...
#[derive(Clone, Copy, Encode, Decode, MaxEncodedLen, TypeInfo, Eq, PartialEq, PartialOrd, Ord)]
...
impl kp_std::fmt::Debug for Public {
    #[cfg(feature = "std")]
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
...
impl kp_std::fmt::Debug for Signature {
    #[cfg(feature = "std")]
...
fn derive_hard_junction(secret_seed: &Seed, cc: &[u8; 32]) -> Seed {
    ("Secp256k1HDKD", secret_seed, cc).using_encoded(kp_core_hashing::blake2_256)
}
