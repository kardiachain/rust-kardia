...
pub use kp_externalities::{Externalities, ExternalitiesExt};
...
/// The Wasm code of a KardiaChain runtime.
#[derive(Clone)]
...
kp_externalities::decl_extension! {
