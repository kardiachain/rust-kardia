...
pub struct NewValidBlock {
    ...
    pub block_parts: ::core::option::Option<super::types::BitArray>,
    #[prost(bool, tag="5")]
    pub is_commit: bool,
}
...
pub struct ProposalPol {
    ...
    #[prost(message, optional, tag="3")]
    pub proposal_pol: ::core::option::Option<super::types::BitArray>,
}
...
pub struct VoteSetBits {
    ...
    pub votes: ::core::option::Option<super::types::BitArray>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Message {
